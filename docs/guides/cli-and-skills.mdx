...
The default output is an executable `.cjs` script + an `output.json` file. The script is re-runnable without Actionbook installed, and the data file is the reusable extraction result.
